            ...
            <div class="panel panel-default">
                ...
                <form class="form-horizontal" method="POST" action="{{ url('/addPost') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" row="5" class="form-control" name="post_body" required></textarea>
                        ...
                        <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="category_id" name="category_id" type="category_id" class="form-control"  value="{{ old('category_id') }}" required autofocus>
